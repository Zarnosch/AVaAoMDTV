...
\begin{document}
	...
	Dieses Kriterium basiert auf der Annahme, dass der für das Verständnis eines Satzes erforderliche mentale Arbeitsaufwand mit dem Grad an Verschachtelung und der Verwendung von Klammern steigt. 
		...
		\newpage
		Der dem Maßstab zugrundeliegende Verzweigungsfaktor des Satzstruktur-Baums muss zunächst experimentell mittels Sample-Tool\footnote{\url{http://devel.cpl.upc.edu/freeling/svn/trunk/src/main/simple_examples/sample.cc}} ermittelt werden. Des Weiteren ist evtl. die Erweiterung der verwendeten Parse-Grammatik notwendig, um den Einfluss von Mehrdeutigkeiten zu verringern.
