...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.neutralColorButton, 1, 1, 1, 1)
        self.bestColorButton = QtWidgets.QPushButton(self.gridWidget)
        self.bestColorButton.setObjectName("bestColorButton")
        self.gridLayout_3.addWidget(self.bestColorButton, 2, 1, 1, 1)
        ...
        self.textEditDiscard = QtWidgets.QPushButton(self.tab_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textEditDiscard.sizePolicy().hasHeightForWidth())
        self.textEditDiscard.setSizePolicy(sizePolicy)
        self.textEditDiscard.setObjectName("textEditDiscard")
        self.horizontalLayout_3.addWidget(self.textEditDiscard)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Choosen Colors:"))
        self.worstColorButton.setText(_translate("MainWindow", "change Color"))
        self.label_4.setText(_translate("MainWindow", "neutral:"))
        self.label_6.setText(_translate("MainWindow", "best:"))
        self.label.setText(_translate("MainWindow", "worst:"))
        ...
        self.textEditDiscard.setText(_translate("MainWindow", "Discard"))
